...
#相关参数设置
print("torch自带VGG加数据增强")
model_name = 'vgg16'
resize, batch_size = 224, 128
PATH = 'Datasets'#读取路径
num_classes = 7#几分类
lr, num_epochs, weight_decay= 10**-5, 50, 0#学习率，迭代次数,权重衰减
#导入模型并部署到设备CPU或者GPU
...
#描绘下降曲线
train_writer = SummaryWriter('logs/VGG16/train')
test_writer = SummaryWriter('logs/VGG16/test')
#数据增强
...
torch.save(best_models,"VGG16.pt")